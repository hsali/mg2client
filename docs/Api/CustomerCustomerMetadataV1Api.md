...
$apiInstance = new Swagger\Client\Api\CustomerCustomerMetadataV1Api(
...
try {
    $result = $apiInstance->customerCustomerMetadataV1GetAttributeMetadataGet($attribute_code);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->customerCustomerMetadataV1GetAttributesGet($form_code);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->customerCustomerMetadataV1GetCustomAttributesMetadataGet($data_interface_name);
    print_r($result);
} catch (Exception $e) {
