...
class GiftMessageGuestCartRepositoryV1Api
{
    ...
    public function giftMessageGuestCartRepositoryV1GetGetWithHttpInfo($cart_id)
    {
        ...
        $request = $this->giftMessageGuestCartRepositoryV1GetGetRequest($cart_id);
     ...
     */
    public function giftMessageGuestCartRepositoryV1GetGetAsync($cart_id)
    {
        return $this->giftMessageGuestCartRepositoryV1GetGetAsyncWithHttpInfo($cart_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function giftMessageGuestCartRepositoryV1GetGetAsyncWithHttpInfo($cart_id)
    {
        $returnType = '\Swagger\Client\Model\GiftMessageDataMessageInterface';
        $request = $this->giftMessageGuestCartRepositoryV1GetGetRequest($cart_id);
     ...
     */
    protected function giftMessageGuestCartRepositoryV1GetGetRequest($cart_id)
    {
        // verify the required parameter 'cart_id' is set
        if ($cart_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cart_id when calling giftMessageGuestCartRepositoryV1GetGet'
            );
        }
     ...
     * @param  \Swagger\Client\Model\Body117 $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return bool
    ...
    {
        $returnType = 'bool';
        $request = $this->giftMessageGuestCartRepositoryV1SavePostRequest($cart_id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function giftMessageGuestCartRepositoryV1SavePostAsync($cart_id, $body = null)
    {
        return $this->giftMessageGuestCartRepositoryV1SavePostAsyncWithHttpInfo($cart_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function giftMessageGuestCartRepositoryV1SavePostAsyncWithHttpInfo($cart_id, $body = null)
    {
        $returnType = 'bool';
        $request = $this->giftMessageGuestCartRepositoryV1SavePostRequest($cart_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function giftMessageGuestCartRepositoryV1SavePostRequest($cart_id, $body = null)
    {
        // verify the required parameter 'cart_id' is set
        if ($cart_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cart_id when calling giftMessageGuestCartRepositoryV1SavePost'
            );
        }
