...
class CheckoutGuestTotalsInformationManagementV1Api
{
    ...
    public function checkoutGuestTotalsInformationManagementV1CalculatePostWithHttpInfo($cart_id, $body = null)
    {
        ...
        $request = $this->checkoutGuestTotalsInformationManagementV1CalculatePostRequest($cart_id, $body);
     ...
     */
    public function checkoutGuestTotalsInformationManagementV1CalculatePostAsync($cart_id, $body = null)
    {
        return $this->checkoutGuestTotalsInformationManagementV1CalculatePostAsyncWithHttpInfo($cart_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkoutGuestTotalsInformationManagementV1CalculatePostAsyncWithHttpInfo($cart_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\QuoteDataTotalsInterface';
        $request = $this->checkoutGuestTotalsInformationManagementV1CalculatePostRequest($cart_id, $body);
     ...
     */
    protected function checkoutGuestTotalsInformationManagementV1CalculatePostRequest($cart_id, $body = null)
    {
        // verify the required parameter 'cart_id' is set
        if ($cart_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cart_id when calling checkoutGuestTotalsInformationManagementV1CalculatePost'
            );
        }
