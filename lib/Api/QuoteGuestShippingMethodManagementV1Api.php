...
class QuoteGuestShippingMethodManagementV1Api
{
    ...
    public function quoteGuestShippingMethodManagementV1GetListGetWithHttpInfo($cart_id)
    {
        ...
        $request = $this->quoteGuestShippingMethodManagementV1GetListGetRequest($cart_id);
     ...
     */
    public function quoteGuestShippingMethodManagementV1GetListGetAsync($cart_id)
    {
        return $this->quoteGuestShippingMethodManagementV1GetListGetAsyncWithHttpInfo($cart_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quoteGuestShippingMethodManagementV1GetListGetAsyncWithHttpInfo($cart_id)
    {
        $returnType = '\Swagger\Client\Model\QuoteDataShippingMethodInterface[]';
        $request = $this->quoteGuestShippingMethodManagementV1GetListGetRequest($cart_id);
     ...
     */
    protected function quoteGuestShippingMethodManagementV1GetListGetRequest($cart_id)
    {
        // verify the required parameter 'cart_id' is set
        if ($cart_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cart_id when calling quoteGuestShippingMethodManagementV1GetListGet'
            );
        }
