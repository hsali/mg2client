...
class CatalogCategoryAttributeRepositoryV1Api
{
    ...
    {
        $returnType = '\Swagger\Client\Model\CatalogDataCategoryAttributeInterface';
        $request = $this->catalogCategoryAttributeRepositoryV1GetGetRequest($attribute_code);
     ...
     */
    public function catalogCategoryAttributeRepositoryV1GetGetAsync($attribute_code)
    {
        return $this->catalogCategoryAttributeRepositoryV1GetGetAsyncWithHttpInfo($attribute_code)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function catalogCategoryAttributeRepositoryV1GetGetAsyncWithHttpInfo($attribute_code)
    {
        $returnType = '\Swagger\Client\Model\CatalogDataCategoryAttributeInterface';
        $request = $this->catalogCategoryAttributeRepositoryV1GetGetRequest($attribute_code);
     ...
     */
    protected function catalogCategoryAttributeRepositoryV1GetGetRequest($attribute_code)
    {
        // verify the required parameter 'attribute_code' is set
        if ($attribute_code === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $attribute_code when calling catalogCategoryAttributeRepositoryV1GetGet'
            );
        }
    ...
    {
        $returnType = '\Swagger\Client\Model\CatalogDataCategoryAttributeSearchResultsInterface';
        $request = $this->catalogCategoryAttributeRepositoryV1GetListGetRequest($search_criteria_filter_groups_filters_field, $search_criteria_filter_groups_filters_value, $search_criteria_filter_groups_filters_condition_type, $search_criteria_sort_orders_field, $search_criteria_sort_orders_direction, $search_criteria_page_size, $search_criteria_current_page);
