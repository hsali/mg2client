...
class CatalogProductMediaAttributeManagementV1Api
{
     ...
     *
     * @param  string $attribute_set_name attribute_set_name (required)
     *
    ...
    public function catalogProductMediaAttributeManagementV1GetListGetWithHttpInfo($attribute_set_name)
    {
        ...
        $request = $this->catalogProductMediaAttributeManagementV1GetListGetRequest($attribute_set_name);
     ...
     */
    public function catalogProductMediaAttributeManagementV1GetListGetAsync($attribute_set_name)
    {
        return $this->catalogProductMediaAttributeManagementV1GetListGetAsyncWithHttpInfo($attribute_set_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function catalogProductMediaAttributeManagementV1GetListGetAsyncWithHttpInfo($attribute_set_name)
    {
        $returnType = '\Swagger\Client\Model\CatalogDataProductAttributeInterface[]';
        $request = $this->catalogProductMediaAttributeManagementV1GetListGetRequest($attribute_set_name);
     ...
     */
    protected function catalogProductMediaAttributeManagementV1GetListGetRequest($attribute_set_name)
    {
        // verify the required parameter 'attribute_set_name' is set
        if ($attribute_set_name === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $attribute_set_name when calling catalogProductMediaAttributeManagementV1GetListGet'
            );
        }
        ...
        if ($attribute_set_name !== null) {
            $resourcePath = str_replace(
                '{' . 'attributeSetName' . '}',
                ObjectSerializer::toPathValue($attribute_set_name),
                $resourcePath
            );
        }
