...
class CheckoutTotalsInformationManagementV1Api
{
    ...
    public function checkoutTotalsInformationManagementV1CalculatePostWithHttpInfo($cart_id, $body = null)
    {
        ...
        $request = $this->checkoutTotalsInformationManagementV1CalculatePostRequest($cart_id, $body);
     ...
     */
    public function checkoutTotalsInformationManagementV1CalculatePostAsync($cart_id, $body = null)
    {
        return $this->checkoutTotalsInformationManagementV1CalculatePostAsyncWithHttpInfo($cart_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkoutTotalsInformationManagementV1CalculatePostAsyncWithHttpInfo($cart_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\QuoteDataTotalsInterface';
        $request = $this->checkoutTotalsInformationManagementV1CalculatePostRequest($cart_id, $body);
     ...
     */
    protected function checkoutTotalsInformationManagementV1CalculatePostRequest($cart_id, $body = null)
    {
        // verify the required parameter 'cart_id' is set
        if ($cart_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cart_id when calling checkoutTotalsInformationManagementV1CalculatePost'
            );
        }
