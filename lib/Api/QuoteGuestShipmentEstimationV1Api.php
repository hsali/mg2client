...
class QuoteGuestShipmentEstimationV1Api
{
    ...
    public function quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostWithHttpInfo($cart_id, $body = null)
    {
        ...
        $request = $this->quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostRequest($cart_id, $body);
     ...
     */
    public function quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostAsync($cart_id, $body = null)
    {
        return $this->quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostAsyncWithHttpInfo($cart_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostAsyncWithHttpInfo($cart_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\QuoteDataShippingMethodInterface[]';
        $request = $this->quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostRequest($cart_id, $body);
     ...
     */
    protected function quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostRequest($cart_id, $body = null)
    {
        // verify the required parameter 'cart_id' is set
        if ($cart_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cart_id when calling quoteGuestShipmentEstimationV1EstimateByExtendedAddressPost'
            );
        }
