...
class QuoteShipmentEstimationV1Api
{
    ...
    public function quoteShipmentEstimationV1EstimateByExtendedAddressPostWithHttpInfo($cart_id, $body = null)
    {
        ...
        $request = $this->quoteShipmentEstimationV1EstimateByExtendedAddressPostRequest($cart_id, $body);
     ...
     */
    public function quoteShipmentEstimationV1EstimateByExtendedAddressPostAsync($cart_id, $body = null)
    {
        return $this->quoteShipmentEstimationV1EstimateByExtendedAddressPostAsyncWithHttpInfo($cart_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quoteShipmentEstimationV1EstimateByExtendedAddressPostAsyncWithHttpInfo($cart_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\QuoteDataShippingMethodInterface[]';
        $request = $this->quoteShipmentEstimationV1EstimateByExtendedAddressPostRequest($cart_id, $body);
     ...
     */
    protected function quoteShipmentEstimationV1EstimateByExtendedAddressPostRequest($cart_id, $body = null)
    {
        // verify the required parameter 'cart_id' is set
        if ($cart_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cart_id when calling quoteShipmentEstimationV1EstimateByExtendedAddressPost'
            );
        }
