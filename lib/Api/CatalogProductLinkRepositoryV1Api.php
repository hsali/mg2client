...
class CatalogProductLinkRepositoryV1Api
{
     ...
     * @param  string $linked_product_sku linked_product_sku (required)
     *
    ...
    {
        $returnType = 'bool';
        $request = $this->catalogProductLinkRepositoryV1DeleteByIdDeleteRequest($sku, $type, $linked_product_sku);
     ...
     */
    public function catalogProductLinkRepositoryV1DeleteByIdDeleteAsync($sku, $type, $linked_product_sku)
    {
        return $this->catalogProductLinkRepositoryV1DeleteByIdDeleteAsyncWithHttpInfo($sku, $type, $linked_product_sku)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function catalogProductLinkRepositoryV1DeleteByIdDeleteAsyncWithHttpInfo($sku, $type, $linked_product_sku)
    {
        $returnType = 'bool';
        $request = $this->catalogProductLinkRepositoryV1DeleteByIdDeleteRequest($sku, $type, $linked_product_sku);
     ...
     */
    protected function catalogProductLinkRepositoryV1DeleteByIdDeleteRequest($sku, $type, $linked_product_sku)
    {
        ...
        if ($linked_product_sku === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $linked_product_sku when calling catalogProductLinkRepositoryV1DeleteByIdDelete'
            );
        }
        ...
        if ($linked_product_sku !== null) {
            $resourcePath = str_replace(
                '{' . 'linkedProductSku' . '}',
                ObjectSerializer::toPathValue($linked_product_sku),
                $resourcePath
            );
        }
