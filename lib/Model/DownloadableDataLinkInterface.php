...
class DownloadableDataLinkInterface implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_shareable'] === null) {
            $invalidProperties[] = "'is_shareable' can't be null";
        }
     ...
     *
     * @param \Swagger\Client\Model\DownloadableDataFileContentInterface $link_file_content link_file_content
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\DownloadableDataLinkExtensionInterface $extension_attributes extension_attributes
     *
     * @return $this
     */
