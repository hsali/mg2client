...
class StoreDataStoreConfigInterface implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['base_link_url'] === null) {
            $invalidProperties[] = "'base_link_url' can't be null";
        }
        if ($this->container['base_static_url'] === null) {
            $invalidProperties[] = "'base_static_url' can't be null";
        }
        if ($this->container['base_media_url'] === null) {
            $invalidProperties[] = "'base_media_url' can't be null";
        }
        if ($this->container['secure_base_url'] === null) {
            $invalidProperties[] = "'secure_base_url' can't be null";
        }
        if ($this->container['secure_base_link_url'] === null) {
            $invalidProperties[] = "'secure_base_link_url' can't be null";
        }
        if ($this->container['secure_base_static_url'] === null) {
            $invalidProperties[] = "'secure_base_static_url' can't be null";
        }
        if ($this->container['secure_base_media_url'] === null) {
            $invalidProperties[] = "'secure_base_media_url' can't be null";
        }
     ...
     *
     * @param \Swagger\Client\Model\StoreDataStoreConfigExtensionInterface $extension_attributes extension_attributes
     *
     * @return $this
     */
