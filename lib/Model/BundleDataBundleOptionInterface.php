...
class BundleDataBundleOptionInterface implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['option_qty'] === null) {
            $invalidProperties[] = "'option_qty' can't be null";
        }
        if ($this->container['option_selections'] === null) {
            $invalidProperties[] = "'option_selections' can't be null";
        }
     ...
     *
     * @param \Swagger\Client\Model\BundleDataBundleOptionExtensionInterface $extension_attributes extension_attributes
     *
     * @return $this
     */
