...
class RmaDataCommentInterface implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['customer_notified'] === null) {
            $invalidProperties[] = "'customer_notified' can't be null";
        }
        if ($this->container['visible_on_front'] === null) {
            $invalidProperties[] = "'visible_on_front' can't be null";
        }
     ...
     *
     * @param \Swagger\Client\Model\RmaDataCommentExtensionInterface $extension_attributes extension_attributes
     *
     * @return $this
     */
