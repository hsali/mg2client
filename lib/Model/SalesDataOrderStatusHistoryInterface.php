...
class SalesDataOrderStatusHistoryInterface implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'parent_id' => 'int',
        'status' => 'string',
        'extension_attributes' => '\Swagger\Client\Model\SalesDataOrderStatusHistoryExtensionInterface'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_customer_notified'] === null) {
            $invalidProperties[] = "'is_customer_notified' can't be null";
        }
     ...
     *
     * @return \Swagger\Client\Model\SalesDataOrderStatusHistoryExtensionInterface
     */
     ...
     *
     * @param \Swagger\Client\Model\SalesDataOrderStatusHistoryExtensionInterface $extension_attributes extension_attributes
     *
     * @return $this
     */
