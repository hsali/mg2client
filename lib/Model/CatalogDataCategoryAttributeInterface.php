...
class CatalogDataCategoryAttributeInterface implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['frontend_labels'] === null) {
            $invalidProperties[] = "'frontend_labels' can't be null";
        }
     ...
     *
     * @param \Swagger\Client\Model\CatalogDataEavAttributeExtensionInterface $extension_attributes extension_attributes
     *
     * @return $this
     */
