...
class CatalogDataProductCustomOptionInterface implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_require'] === null) {
            $invalidProperties[] = "'is_require' can't be null";
        }
     ...
     * Sets image_size_x
     *
     * @param int $image_size_x image_size_x
     *
     * @return $this
     */
     ...
     * Sets image_size_y
     *
     * @param int $image_size_y image_size_y
     *
     * @return $this
     */
     ...
     * Sets values
     *
     * @param \Swagger\Client\Model\CatalogDataProductCustomOptionValuesInterface[] $values values
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\CatalogDataProductCustomOptionExtensionInterface $extension_attributes extension_attributes
     *
     * @return $this
     */
