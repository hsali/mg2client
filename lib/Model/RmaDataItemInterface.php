...
class RmaDataItemInterface implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['rma_entity_id'] === null) {
            $invalidProperties[] = "'rma_entity_id' can't be null";
        }
        if ($this->container['order_item_id'] === null) {
            $invalidProperties[] = "'order_item_id' can't be null";
        }
        if ($this->container['qty_requested'] === null) {
            $invalidProperties[] = "'qty_requested' can't be null";
        }
        if ($this->container['qty_authorized'] === null) {
            $invalidProperties[] = "'qty_authorized' can't be null";
        }
        if ($this->container['qty_approved'] === null) {
            $invalidProperties[] = "'qty_approved' can't be null";
        }
        if ($this->container['qty_returned'] === null) {
            $invalidProperties[] = "'qty_returned' can't be null";
        }
     ...
     *
     * @param \Swagger\Client\Model\RmaDataItemExtensionInterface $extension_attributes extension_attributes
     *
     * @return $this
     */
