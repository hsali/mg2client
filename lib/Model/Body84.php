...
class Body84 implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['address_information'] === null) {
            $invalidProperties[] = "'address_information' can't be null";
        }
     ...
     *
     * @param \Swagger\Client\Model\CheckoutDataShippingInformationInterface $address_information address_information
     *
     * @return $this
     */
